...
#ifndef __MV88E6071_H
#define __MV88E6071_H
//FIXME define need to check
#define MV88E6071_PORTS	7

#define REG_PORT(p)		(0x18 + (p))
...
#define MOXA_IOTHINX4530_SWITHPHY_MIN 0x10
#define MOXA_IOTHINX4530_SWITHPHY_MAX 0x14
#endif
